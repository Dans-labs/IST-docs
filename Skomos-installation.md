---
title: running skosmos + fuseki via docker compose
...
* [RDF](https://www.w3.org/TR/2004/REC-rdf-concepts-20040210) (Resource Description Framework): method to describe and exchange graph data (see also https://www.w3.org/TR/rdf11-primer/)
* [RDFS](https://www.w3.org/TR/rdf-schema/): data-modelling vocabulary, defining:
    * rdfs:Class
    * rdf:Property
    * ... 
* [SKOS](https://www.w3.org/TR/skos-reference/) (SKOS Simple Knowledge Organization System) (see also https://www.w3.org/TR/skos-primer/)
    * skos:Concept (class)
    * skos:ConceptScheme (class)
    * skos:Collection (class)
    * skos:OrderedCollection (class)
...
SELECT * WHERE {
 ...
 unescothes:C02644 ?p ?o
    }
}
```

todo: explore fuseki curl commands + sparql query 

curl --data-urlencode "query@unesco.rq"  http://localhost:9030/skosmos/sparql # running skosmos + fuseki via docker compose
...
curl --data-urlencode "query@unesco.rq"  http://localhost:9030/skosmos/sparql 